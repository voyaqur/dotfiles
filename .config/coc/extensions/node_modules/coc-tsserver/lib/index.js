...
var init_main = __esm({
  "node_modules/vscode-languageserver-types/lib/esm/main.js"() {
    ...
    EOL = ["\n", "\r\n", "\r"];
    (function(TextDocument21) {
      function create(uri, languageId, version, content) {
        return new FullTextDocument(uri, languageId, version, content);
      }
      TextDocument21.create = create;
      function is(value) {
        var candidate = value;
        return Is.defined(candidate) && Is.string(candidate.uri) && (Is.undefined(candidate.languageId) || Is.string(candidate.languageId)) && Is.uinteger(candidate.lineCount) && Is.func(candidate.getText) && Is.func(candidate.positionAt) && Is.func(candidate.offsetAt) ? true : false;
      }
      TextDocument21.is = is;
      ...
      TextDocument21.applyEdits = applyEdits;
...
var require_windows = __commonJS({
  "node_modules/isexe/windows.js"(exports2, module2) {
    ...
    function isexe(path21, options, cb) {
      fs10.stat(path21, function(er, stat) {
...
var init_api = __esm({
  "src/server/utils/api.ts"() {
    ...
    _API.v203 = _API.fromSimpleString("2.0.3");
    _API.v206 = _API.fromSimpleString("2.0.6");
    _API.v208 = _API.fromSimpleString("2.0.8");
    _API.v213 = _API.fromSimpleString("2.1.3");
    _API.v220 = _API.fromSimpleString("2.2.0");
    _API.v222 = _API.fromSimpleString("2.2.2");
    _API.v230 = _API.fromSimpleString("2.3.0");
    _API.v234 = _API.fromSimpleString("2.3.4");
    _API.v240 = _API.fromSimpleString("2.4.0");
    _API.v250 = _API.fromSimpleString("2.5.0");
    _API.v260 = _API.fromSimpleString("2.6.0");
    _API.v270 = _API.fromSimpleString("2.7.0");
    _API.v280 = _API.fromSimpleString("2.8.0");
    _API.v290 = _API.fromSimpleString("2.9.0");
    _API.v291 = _API.fromSimpleString("2.9.1");
    _API.v292 = _API.fromSimpleString("2.9.2");
    _API.v300 = _API.fromSimpleString("3.0.0");
    _API.v310 = _API.fromSimpleString("3.1.0");
    _API.v314 = _API.fromSimpleString("3.1.4");
    _API.v320 = _API.fromSimpleString("3.2.0");
    _API.v330 = _API.fromSimpleString("3.3.0");
    _API.v333 = _API.fromSimpleString("3.3.3");
    _API.v340 = _API.fromSimpleString("3.4.0");
    _API.v345 = _API.fromSimpleString("3.4.5");
    _API.v350 = _API.fromSimpleString("3.5.0");
    _API.v370 = _API.fromSimpleString("3.7.0");
    _API.v380 = _API.fromSimpleString("3.8.0");
    _API.v381 = _API.fromSimpleString("3.8.1");
    ...
    _API.v480 = _API.fromSimpleString("4.8.0");
...
var require_disposable = __commonJS({
  "node_modules/vscode-jsonrpc/lib/common/disposable.js"(exports2) {
    ...
    })(Disposable15 = exports2.Disposable || (exports2.Disposable = {}));
  }
});
...
var require_cancellation = __commonJS({
  "node_modules/vscode-jsonrpc/lib/common/cancellation.js"(exports2) {
    ...
    })(CancellationToken26 = exports2.CancellationToken || (exports2.CancellationToken = {}));
    ...
    exports2.CancellationTokenSource = CancellationTokenSource5;
  }
});
  ...
  "node_modules/vscode-jsonrpc/lib/node/main.js"(exports2) {
    ...
    function generateRandomPipeName() {
      ...
      if (XDG_RUNTIME_DIR) {
        ...
        result = path21.join(os5.tmpdir(), `vscode-${randomSuffix}.sock`);
      }
...
var init_typeConverters = __esm({
  "src/server/utils/typeConverters.ts"() {
    ...
    ((Position12) => {
      Position12.fromLocation = (tslocation) => {
        return {
          line: tslocation.line - 1,
          character: tslocation.offset - 1
        };
      };
      Position12.toLocation = (position) => ({
        line: position.line + 1,
        offset: position.character + 1
      });
      Position12.toFileLocationRequestArgs = (file2, position) => ({
        file: file2,
        line: position.line + 1,
        offset: position.character + 1
      });
...
var import_coc47, import_fs7, import_path14, import_util, nulToken, updateImportsOnFileMoveName, UpdateImportsOnFileRenameHandler;
var init_updatePathOnRename = __esm({
  "src/server/features/updatePathOnRename.ts"() {
    import_coc47 = require("coc.nvim");
    ...
    init_typeConverters();
    nulToken = import_coc47.CancellationToken.None;
    ...
    UpdateImportsOnFileRenameHandler = class {
      constructor(client, fileConfigurationManager, _handles) {
        ...
        const watcher = import_coc47.workspace.createFileSystemWatcher(glob);
        ...
        watcher.onDidRename(async (e) => {
          ...
          this._delayer.trigger(() => {
            import_coc47.window.withProgress({
      ...
      getConfiguration(resource) {
        return import_coc47.workspace.getConfiguration(doesResourceLookLikeATypeScriptFile(resource) ? "typescript" : "javascript", resource);
      }
      async flushRenames() {
        ...
        for (const group of this.groupRenames(renames)) {
          ...
          for (const { oldUri, newUri, newFilePath, oldFilePath, jsTsFileThatIsBeingMoved } of group) {
            const document = await import_coc47.workspace.openTextDocument(jsTsFileThatIsBeingMoved);
          ...
          if (Object.keys(edits.changes ?? {}).length > 0) {
            if (await this.confirmActionWithUser(resourcesBeingRenamed)) {
              await import_coc47.workspace.applyEdit(edits);
            }
          }
        }
      }
      ...
      async promptUser(newResources) {
        ...
        const response = await import_coc47.window.showInformationMessage(
          newResources.length === 1 ? `Update imports for '${import_path14.default.basename(newResources[0].fsPath)}'?` : this.getConfirmMessage(`Update imports for the following ${newResources.length} files?`, newResources),
          rejectItem,
          acceptItem
        );
        switch (response) {
      ...
      async getJsTsFileBeingMoved(resource) {
        ...
        if (await isDirectory(resource)) {
          const files = await import_coc47.workspace.findFiles(new import_coc47.RelativePattern(resource, "**/*.{ts,tsx,js,jsx}"), "**/node_modules/**", 1);
          return files[0];
        }
      ...
      getConfirmMessage(start, resourcesToConfirm) {
        ...
        const paths = [start];
        paths.push("");
        paths.push(...resourcesToConfirm.slice(0, MAX_CONFIRM_FILES).map((r) => import_path14.default.basename(r.fsPath)));
...
var Resolver = class {
  ...
  resolve(folder) {
    ...
    if (import_fs.default.existsSync(file2)) return file2;
    return void 0;
  }
};
...
var autoFixableDiagnosticCodes = /* @__PURE__ */ new Set([
  2420,
  // Incorrectly implemented interface
  2552,
  // Cannot find name
  2304
  // Cannot find name
...
`
      ...
      for (let change of fix.changes) {
        if (change.fileName != file2) continue;
    ...
    if (command) import_coc3.commands.executeCommand(command);
  }
};
...
var _FileReferencesCommand = class _FileReferencesCommand {
  constructor(service) {
    this.service = service;
...
var _SourceDefinitionCommand = class _SourceDefinitionCommand {
  constructor(service) {
    this.service = service;
...
var _WatchProject = class _WatchProject {
...
_WatchProject.id = "tsserver.watchBuild";
_WatchProject.startTexts = ["Starting compilation in watch mode", "Starting incremental compilation"];
...
async function resolveConfigFile(client, file2) {
  ...
  if (configFileName && configFileName.startsWith("/dev/null")) return void 0;
...
var FileConfigurationManager = class {
  ...
  async ensureConfigurationOptions(document, insertSpaces, tabSize, token) {
    ...
    if (cachedOption && equals3(cachedOption.formatOptions, currentOptions.formatOptions) && equals3(cachedOption.preferences, currentOptions.preferences)) return;
  ...
  async setGlobalConfigurationFromDocument(document, token) {
    const formattingOptions = this.getFormattingOptions(document) ?? await import_coc5.workspace.getFormatOptions(document.uri);
    const args = {
      file: void 0,
  ...
  getFormatOptions(options, language2, uri) {
    ...
    return {
      ...
      indentSwitchCase: config.get("indentSwitchCase", true)
    };
  }
  ...
  getMaximumHoverLength(config) {
    const defaultMaxLength = 500;
    const maximumHoverLength = config.get("hover.maximumLength", defaultMaxLength);
    if (!Number.isSafeInteger(maximumHoverLength) || maximumHoverLength <= 0) {
      return defaultMaxLength;
    }
    return maximumHoverLength;
  }
  getOrganizeImportsPreferences(config) {
    const collation = config.get("organizeImports.unicodeCollation", "ordinal");
    const caseSensitivity = config.get("organizeImports.caseSensitivity", "auto");
    const typeOrder = config.get("organizeImports.typeOrder", "auto");
    const prefs = {
      organizeImportsTypeOrder: typeOrder === "auto" ? void 0 : typeOrder,
      organizeImportsIgnoreCase: caseSensitivity === "caseInsensitive" ? true : caseSensitivity === "caseSensitive" ? false : "auto",
      organizeImportsCollation: collation
    };
    if (collation === "unicode") {
      const caseFirst = config.get("organizeImports.caseFirst", "default");
      prefs.organizeImportsCaseFirst = caseSensitivity === "caseInsensitive" ? void 0 : caseFirst === "default" ? void 0 : caseFirst;
      prefs.organizeImportsAccentCollation = config.get("organizeImports.accentCollation", void 0);
      prefs.organizeImportsLocale = config.get("organizeImports.locale", void 0);
      prefs.organizeImportsNumericCollation = config.get("organizeImports.numericCollation", void 0);
    }
    return prefs;
  }
  ...
  getAutoImportSpecifierExcludeRegexesPreference(config) {
    const regexes = config.get("autoImportSpecifierExcludeRegexes");
    return Array.isArray(regexes) && regexes.length ? regexes : void 0;
  }
  dispose() {
...
var TypeScriptWorkspaceSymbolProvider = class _TypeScriptWorkspaceSymbolProvider {
...
var SnippetString = class _SnippetString {
  constructor(value) {
    this._tabstop = 1;
    this.value = value || "";
  }
...
// src/server/features/completionItemProvider.ts
init_typeConverters();
var _ApplyCompletionCodeActionCommand = class _ApplyCompletionCodeActionCommand {
  constructor(client) {
    this.client = client;
...
var TypeScriptDocumentSymbolProvider = class _TypeScriptDocumentSymbolProvider {
  constructor(client) {
    this.client = client;
  }
      ...
      if (response.type == "response" && response.body) {
        ...
        if (tree.childItems) {
          ...
          tree.childItems.forEach(
            (item) => _TypeScriptDocumentSymbolProvider.convertNavTree(
              result,
              item
            )
          );
  ...
  static convertNavTree(output, item) {
    let shouldInclude = _TypeScriptDocumentSymbolProvider.shouldIncludeEntry(item);
    ...
    for (const span of item.spans) {
      ...
      for (const child of children) {
        if (child.spans.some((span2) => !!containsRange(range, Range3.fromTextSpan(span2)))) {
          const includedChild = _TypeScriptDocumentSymbolProvider.convertNavTree(symbolInfo.children, child);
...
var _SourceFixAll = class _SourceFixAll extends SourceAction {
  constructor() {
    super();
...
_SourceFixAll.kind = import_coc15.CodeActionKind.SourceFixAll + ".ts";
var SourceFixAll = _SourceFixAll;
var _SourceRemoveUnused = class _SourceRemoveUnused extends SourceAction {
  constructor() {
    super();
...
_SourceRemoveUnused.kind = import_coc15.CodeActionKind.Source + ".removeUnused.ts";
var SourceRemoveUnused = _SourceRemoveUnused;
var _SourceAddMissingImports = class _SourceAddMissingImports extends SourceAction {
  constructor() {
    super();
...
_SourceAddMissingImports.kind = import_coc15.CodeActionKind.Source + ".addMissingImports.ts";
var SourceAddMissingImports = _SourceAddMissingImports;
var _TypeScriptAutoFixProvider = class _TypeScriptAutoFixProvider {
...
init_main();
init_typeConverters();
var TypeScriptFoldingProvider = class _TypeScriptFoldingProvider {
  constructor(client) {
    this.client = client;
  }
...
init_typeConverters();
var TypeScriptHoverProvider = class _TypeScriptHoverProvider {
  constructor(client) {
    this.client = client;
  }
  async provideHover(document, position, token) {
    ...
    try {
      ...
      if (response && response.type == "response" && response.body) {
        ...
        return {
          contents: _TypeScriptHoverProvider.getContents(data),
...
var TypeScriptImplementationsCodeLensProvider = class extends TypeScriptBaseCodeLensProvider {
  ...
  extractSymbol(document, item, parent) {
    ...
    const config = import_coc18.workspace.getConfiguration(`${lang}.implementationsCodeLens`, document);
    const kindModifiers = item.kindModifiers ?? "";
    if (item.kind === Kind.interface) {
      return getSymbolRange(document, item);
    }
    if ((item.kind === Kind.class || item.kind === Kind.method || item.kind === Kind.memberVariable || item.kind === Kind.memberGetAccessor || item.kind === Kind.memberSetAccessor) && /\babstract\b/.test(kindModifiers)) {
      return getSymbolRange(document, item);
    }
    if (item.kind === Kind.method && (parent == null ? void 0 : parent.kind) === Kind.interface && config.get("showOnInterfaceMethods", false)) {
      return getSymbolRange(document, item);
    }
    if (item.kind === Kind.method && (parent == null ? void 0 : parent.kind) === Kind.class && config.get("showOnAllClassMethods", false)) {
...
var ImportFixProvider = class {
  ...
  async provideCodeActions(document, _range, context, _token) {
    ...
    let edits = [];
    let names = [];
    let doc = import_coc19.workspace.getDocument(document.uri);
    let command;
    for (const diagnostic of diagnostics) {
      let { range } = diagnostic;
...
var TypeScriptInlayHintsProvider = class {
  constructor(language2, client, fileConfigurationManager) {
    ...
    this.fileConfigurationManager = fileConfigurationManager;
    this.disposables = [];
    this._onDidChangeInlayHints = new import_coc20.Emitter();
    this.onDidChangeInlayHints = this._onDidChangeInlayHints.event;
    let section = `${language2.id}.inlayHints`;
    import_coc20.workspace.onDidChangeConfiguration(async (e) => {
      if (e.affectsConfiguration(section)) {
        this._onDidChangeInlayHints.fire();
      }
    }, null, this.disposables);
    import_coc20.workspace.onDidChangeTextDocument((e) => {
      let doc = import_coc20.workspace.getDocument(e.textDocument.uri);
...
function areInlayHintsEnabledForFile(language2, document) {
  const config = import_coc20.workspace.getConfiguration(language2.id, document.uri);
...
init_typeConverters();
var defaultJsDoc = new import_coc21.SnippetString(`/**
 * $0
 */`);
function createCompleteItem(document, position) {
  ...
  const start = import_coc21.Position.create(position.line, prefix ? position.character - prefix[0].length : position.character);
  const range = import_coc21.Range.create(start, import_coc21.Position.create(start.line, start.character + (suffix ? suffix[0].length : 0)));
  let insert = `/** */`;
  return {
    label: insert,
    kind: import_coc21.CompletionItemKind.Text,
    insertTextFormat: import_coc21.InsertTextFormat.Snippet,
...
var JsDocCompletionProvider = class {
  ...
  async provideCompletionItems(document, position, token) {
    if (!import_coc21.workspace.getConfiguration(this.language.id, document.uri).get("suggest.completeJSDocs")) {
      return void 0;
    }
    const file2 = this.client.toOpenedFilePath(document.uri);
    if (!file2) {
...
function templateToSnippet(template) {
  ...
  return new import_coc21.SnippetString(template);
}
...
var InstallModuleProvider = class {
  constructor(id) {
    if (id === "typescript") {
      import_coc22.commands.registerCommand("_tsserver.installModule", async (uri, name) => {
        await installModules(uri, [name]);
      });
    }
  }
  async provideCodeActions(document, _range, context, _token) {
    const uri = import_coc22.Uri.parse(document.uri);
...
init_api();
init_typeConverters();
var _ApplyCodeActionCommand = class _ApplyCodeActionCommand {
  constructor(client) {
    this.client = client;
...
var _ApplyFixAllCodeAction = class _ApplyFixAllCodeAction {
  ...
  async execute(document, file2, tsAction) {
    ...
    try {
      ...
      await import_coc23.workspace.applyEdit(edit);
...
var DiagnosticsSet = class _DiagnosticsSet {
  constructor(_values) {
...
init_api();
init_typeConverters();
var _ApplyRefactoringCommand = class _ApplyRefactoringCommand {
  constructor(client) {
    this.client = client;
  ...
  async execute(document, file2, refactor, action, range) {
    ...
    if (!await import_coc24.workspace.applyEdit(workspaceEdit)) {
      return false;
    }
    const renameLocation = response.body.renameLocation;
    if (renameLocation) {
      import_coc24.commands.executeCommand(
  ...
  async toWorkspaceEdit(body) {
    ...
    for (const edit of body.edits) {
      ...
      if (import_coc24.Uri.parse(resource).scheme === "file") {
  ...
  async getTargetFile(document, file2, range) {
    ...
    const root = import_coc24.Uri.parse(import_coc24.workspace.getWorkspaceFolder(document.uri).uri).fsPath;
    const files = response.body.files.map((filepath) => {
      let relative = import_path7.default.relative(root, filepath);
      return relative.startsWith(".") ? filepath.replace(import_os.default.homedir(), "") : relative;
    });
    return await import_coc24.window.showQuickPick(files, { title: "Move to file..." });
  }
};
_ApplyRefactoringCommand.ID = "_typescript.applyRefactoring";
var ApplyRefactoringCommand = _ApplyRefactoringCommand;
var _SelectRefactorCommand = class _SelectRefactorCommand {
  ...
  async execute(document, file2, info, range) {
    let { actions } = info;
    const idx = actions.length == 1 ? 0 : await import_coc24.window.showQuickpick(
...
var _TypeScriptRefactorProvider = class _TypeScriptRefactorProvider {
  ...
  async provideCodeActions(document, range, context, token) {
    ...
    const args = {
      ...
      triggerReason: context.triggerKind === import_coc24.CodeActionTriggerKind.Invoked ? "invoked" : "implicit",
...
_TypeScriptRefactorProvider.extractFunctionKind = import_vscode_languageserver_protocol11.CodeActionKind.RefactorExtract + ".function";
_TypeScriptRefactorProvider.extractConstantKind = import_vscode_languageserver_protocol11.CodeActionKind.RefactorExtract + ".constant";
_TypeScriptRefactorProvider.moveKind = import_vscode_languageserver_protocol11.CodeActionKind.Refactor + ".move";
...
var TypeScriptReferencesCodeLensProvider = class extends TypeScriptBaseCodeLensProvider {
  ...
  extractSymbol(document, item, parent) {
    ...
    switch (item.kind) {
      case Kind.function: {
        const showOnAllFunctions = import_coc25.workspace.getConfiguration(this.modeId).get("referencesCodeLens.showOnAllFunctions");
...
function positionInRange(position, range) {
  let { start, end } = range;
  if (comparePosition2(position, start) < 0) return -1;
  if (comparePosition2(position, end) > 0) return 1;
  return 0;
}
var TypeScriptRenameProvider = class {
  ...
  async execRename(document, position, token) {
    const file2 = this.client.toPath(document.uri);
    if (!file2) return void 0;
    const renameMatchingJsxTags = import_coc26.workspace.getConfiguration(this.language.id).get("preferences.renameMatchingJsxTags", true);
  ...
  async renameFile(fileToRename, newName, token) {
    if (!import_path8.default.extname(newName)) {
      newName += import_path8.default.extname(fileToRename);
    }
    const dirname = import_path8.default.dirname(fileToRename);
    const newFilePath = import_path8.default.join(dirname, newName);
    const args = {
      file: fileToRename,
    ...
    edits.documentChanges.push({
      kind: "rename",
      oldUri: import_coc26.Uri.file(fileToRename).toString(),
      newUri: import_coc26.Uri.file(newFilePath).toString(),
      options: {
        overwrite: false,
        ignoreIfExists: true
      }
...
var TypeScriptDocumentSemanticTokensProvider = class {
  ...
  async provideSemanticTokens(document, requestArg, token) {
    ...
    if (versionBeforeRequest !== versionAfterRequest) {
      ...
      if (typeof import_coc27.CancellationError !== "undefined") {
        throw new import_coc27.CancellationError();
      }
    }
    const tokenSpan = response.body.spans;
    const builder = new import_coc27.SemanticTokensBuilder();
...
// src/server/features/signatureHelpState.ts
var SignatureHelpState = class {
  constructor() {
    this.requestIds = /* @__PURE__ */ new WeakMap();
    this.previousSignatureHelpState = /* @__PURE__ */ new WeakMap();
  }
  ...
  getActiveSignature(document, requestId, context, typeScriptSelectedSignatureIndex, signatures) {
    ...
    if (context.isRetrigger && previousSignatureHelpState && previouslyActiveSignatureHelp && this.hasMatchingSignatures(previouslyActiveSignatureHelp.signatures, previousSignatureHelpState.signatureLabels)) {
      ...
      if (previouslyActiveSignatureHelp.activeSignature !== previousSignatureHelpState.activeSignatureIndex) {
        userSelectedSignatureLabel = (_a = previouslyActiveSignatureHelp.signatures[previouslyActiveSignatureHelp.activeSignature]) == null ? void 0 : _a.label;
      }
    }
    let activeSignatureIndex = typeScriptSelectedSignatureIndex;
    if (userSelectedSignatureLabel !== void 0) {
      ...
      if (userSelectedSignatureIndex >= 0) {
        ...
        userSelectedSignatureLabel = void 0;
      }
    }
  ...
  hasMatchingSignatures(signatures, signatureLabels) {
    return signatures.length === signatureLabels.length && signatures.every((signature, index) => signature.label === signatureLabels[index]);
  }
};
...
var TypeScriptSignatureHelpProvider = class {
  constructor(client) {
    this.client = client;
    this.state = new SignatureHelpState();
  }
...
function toTsTriggerReason(context) {
  switch (context.triggerKind) {
    case import_vscode_languageserver_protocol13.SignatureHelpTriggerKind.TriggerCharacter:
      if (context.triggerCharacter) {
    ...
    case import_vscode_languageserver_protocol13.SignatureHelpTriggerKind.ContentChange:
      return context.isRetrigger ? { kind: "retrigger" } : { kind: "invoked" };
    case import_vscode_languageserver_protocol13.SignatureHelpTriggerKind.Invoke:
    default:
      return { kind: "invoked" };
  }
}
...
init_typeConverters();
var SmartSelection = class _SmartSelection {
  constructor(client) {
    this.client = client;
  }
  ...
  static convertSelectionRange(selectionRange) {
    return {
      ...
      parent: selectionRange.parent ? _SmartSelection.convertSelectionRange(selectionRange.parent) : void 0
    };
  }
};
...
init_typeConverters();
var _TagClosing = class _TagClosing {
  constructor(client, descriptionLanguageId) {
    ...
    this._cancel = void 0;
    this._enable = true;
    this.checkConfig(import_coc28.window.activeTextEditor);
    import_coc28.events.on("TextInsert", this.onInsertChange, this, this._disposables);
    import_coc28.window.onDidChangeActiveTextEditor((e) => {
      this.checkConfig(e);
    }, null, this._disposables);
    import_coc28.workspace.onDidChangeConfiguration((e) => {
  ...
  checkConfig(editor) {
    ...
    this._enable = import_coc28.workspace.getConfiguration(void 0, uri).get(`${id}.autoClosingTags`, true);
  }
  async onInsertChange(bufnr, change, lastInsert) {
    let doc = import_coc28.workspace.getDocument(bufnr);
    ...
    this._timeout = setTimeout(async () => {
      ...
      const position = import_coc28.Position.create(lnum - 1, pre.length);
      const args = Position2.toFileLocationRequestArgs(
        filepath,
        position
      );
      this._cancel = new import_coc28.CancellationTokenSource();
      ...
      if (doc.changedtick === changedtick) {
        import_coc28.snippetManager.insertSnippet(
          this.getTagSnippet(insertion).value,
          false,
          import_coc28.Range.create(position, position)
        );
        ...
        if (!nowarning) {
          ...
          let res = await import_coc28.window.showWarningMessage(
            `Automatic inserted tag by coc-tsserver, use configuration "${filetype}.autoClosingTags": false to disable this behavior`,
            ...items
          );
          if (res == null) return;
          if (res.id == 1) {
            let config = import_coc28.workspace.getConfiguration(filetype, null);
  ...
  dispose() {
    ...
    (0, import_coc28.disposeAll)(this._disposables);
    this._disposables = [];
  }
...
_TagClosing._configurationLanguages = {
...
var organizeImportsCommand = {
  ...
  kind: import_coc29.CodeActionKind.SourceOrganizeImports,
  mode: "All" /* All */
};
var sortImportsCommand = {
  ...
  minVersion: API.v430,
  title: "Sort Imports",
  kind: import_coc29.CodeActionKind.Source + ".sortImports",
...
var removeUnusedImportsCommand = {
  ...
  kind: import_coc29.CodeActionKind.Source + ".removeUnusedImports",
...
var OrganizeImportsCommand = class {
  ...
  async execute(file2) {
    if (!file2) {
      const activeEditor = import_coc29.window.activeTextEditor;
      if (!activeEditor) {
        import_coc29.window.showErrorMessage("Organize Imports failed. No resource provided.");
        return;
      }
      const resource = activeEditor.document.uri;
      const openedFiledPath = this.client.toOpenedFilePath(resource);
      if (!openedFiledPath) {
        import_coc29.window.showErrorMessage("Organize Imports failed. Unknown file type.");
        return;
      }
    ...
    const response = await this.client.interruptGetErr(() => this.client.execute("organizeImports", args, import_coc29.CancellationToken.None));
    if (response.type !== "response" || !response.body) {
      return;
    }
    if (response.body.length) {
      const edits = WorkspaceEdit2.fromFileCodeEdits(this.client, response.body);
      return import_coc29.workspace.applyEdit(edits);
    }
  }
};
  ...
  constructor(id, client, fileConfigManager) {
    ...
    for (let cmd of allCommands) {
      for (let commandId of cmd.ids) {
        ...
        this.disposables.push(import_coc29.commands.registerCommand(command.id, command.execute, command, true));
      }
    }
  }
  async provideCodeActions(document, _range, context, token) {
    ...
    for (let cmd of allCommands) {
      ...
      for (let commandId of cmd.ids) {
        if (!commandId.startsWith(this.id)) continue;
        let action = import_vscode_languageserver_protocol14.CodeAction.create(cmd.title, {
          title: "",
          command: commandId,
          arguments: [file2]
        }, cmd.kind);
...
var LanguageProvider = class {
  ...
  configurationChanged() {
    const config = import_coc30.workspace.getConfiguration(this.id);
  ...
  dispose() {
    (0, import_coc30.disposeAll)(this.disposables);
  }
  ...
  registerProviders(client, typingsStatus) {
    ...
    this._register(
      import_coc30.languages.registerCompletionItemProvider(
        `tsc-${id}`,
        "TSC",
    ...
    if (this.client.apiVersion.gte(API.v230)) {
      this._register(import_coc30.languages.registerCompletionItemProvider(
        `${id}-directive`,
        "TSC",
        documentSelector.syntax,
    ...
    this._register(import_coc30.languages.registerDefinitionProvider(documentSelector.syntax, definitionProvider));
    this._register(import_coc30.languages.registerTypeDefinitionProvider(documentSelector.syntax, definitionProvider));
    if (hasSemantic) {
      this._register(import_coc30.languages.registerImplementationProvider(documentSelector.semantic, definitionProvider));
    }
    this._register(import_coc30.languages.registerReferencesProvider(documentSelector.syntax, new TypeScriptReferences(client)));
    this._register(import_coc30.languages.registerHoverProvider(documentSelector.syntax, new TypeScriptHoverProvider(client)));
    this._register(import_coc30.languages.registerDocumentHighlightProvider(documentSelector.syntax, new TypeScriptDocumentHighlightProvider(this.client)));
    this._register(import_coc30.languages.registerSignatureHelpProvider(documentSelector.syntax, new TypeScriptSignatureHelpProvider(client), ["(", ",", "<", ")"]));
    this._register(import_coc30.languages.registerDocumentSymbolProvider(documentSelector.syntax, new TypeScriptDocumentSymbolProvider(client)));
    if (hasSemantic) {
      const provider = new TypeScriptRenameProvider(this.description, client, this.fileConfigurationManager);
      this._register(import_coc30.languages.registerRenameProvider(documentSelector.semantic, provider));
    }
    let formatProvider = new TypeScriptFormattingProvider(client, this.fileConfigurationManager);
    this._register(import_coc30.languages.registerDocumentFormatProvider(documentSelector.syntax, formatProvider));
    this._register(import_coc30.languages.registerDocumentRangeFormatProvider(documentSelector.syntax, formatProvider));
    this._register(import_coc30.languages.registerOnTypeFormattingEditProvider(documentSelector.syntax, formatProvider, [";", "}", "\n", String.fromCharCode(27)]));
    this._register(import_coc30.languages.registerCodeActionProvider(documentSelector.syntax, new InstallModuleProvider(id), "tsserver"));
    if (this.client.apiVersion.gte(API.v380) && typeof import_coc30.languages["registerCallHierarchyProvider"] === "function" && hasSemantic) {
      this._register(import_coc30.languages.registerCallHierarchyProvider(documentSelector.semantic, new TypeScriptCallHierarchySupport(client)));
    }
    if (this.client.apiVersion.gte(API.v370) && hasSemantic) {
      const provider = new TypeScriptDocumentSemanticTokensProvider(client);
      if (typeof import_coc30.languages["registerDocumentRangeSemanticTokensProvider"] === "function") {
        this._register(import_coc30.languages.registerDocumentRangeSemanticTokensProvider(documentSelector.semantic, provider, provider.getLegend()));
      }
    }
    ...
    if (this.client.apiVersion.gte(API.v280)) {
      this._register(import_coc30.languages.registerFoldingRangeProvider(documentSelector.syntax, new TypeScriptFoldingProvider(this.client)));
      if (hasSemantic) {
        let provider = new OrganizeImportsCodeActionProvider(id, this.client, this.fileConfigurationManager);
        this._register(
          import_coc30.languages.registerCodeActionProvider(documentSelector.semantic, provider, "tsserver", provider.metadata.providedCodeActionKinds)
        );
    ...
    if (hasSemantic) {
      this._register(
        import_coc30.languages.registerCodeActionProvider(
          ...
          "tsserver",
          [import_coc30.CodeActionKind.QuickFix]
        )
      );
    }
    this._register(
    ...
    if (hasSemantic) {
      ...
      if (this.client.apiVersion.gte(API.v206) && conf.get("referencesCodeLens.enabled")) {
        this._register(import_coc30.languages.registerCodeLensProvider(documentSelector.semantic, new TypeScriptReferencesCodeLensProvider(client, cachedResponse, id)));
      }
      if (this.client.apiVersion.gte(API.v220) && conf.get("implementationsCodeLens.enabled")) {
        this._register(import_coc30.languages.registerCodeLensProvider(documentSelector.semantic, new TypeScriptImplementationsCodeLensProvider(client, cachedResponse, id)));
      }
    }
    if (this.client.apiVersion.gte(API.v350)) {
      this._register(import_coc30.languages.registerSelectionRangeProvider(documentSelector.syntax, new SmartSelection(this.client)));
    }
    if (this.client.apiVersion.gte(API.v300)) {
      this._register(new TagClosing(this.client, id));
    }
    if (this.client.apiVersion.gte(API.v440) && hasSemantic) {
      if (typeof import_coc30.languages.registerInlayHintsProvider === "function") {
        let provider = new TypeScriptInlayHintsProvider(this.description, this.client, this.fileConfigurationManager);
        this._register(provider);
        this._register(import_coc30.languages.registerInlayHintsProvider(documentSelector.semantic, provider));
      } else {
    ...
    if (this.client.apiVersion.gte(API.v510)) {
      ...
      this._register(import_coc30.languages.registerLinkedEditingRangeProvider(documentSelector.semantic, provider));
    }
  }
  handles(resource, doc) {
    ...
    return this.handlesConfigFile(import_coc30.Uri.parse(resource));
  }
  handlesConfigFile(uri) {
    const base2 = import_path9.default.basename(uri.fsPath);
    return !!base2 && (!!this.description.configFilePattern && this.description.configFilePattern.test(base2));
  }
  handlesUri(resource) {
    const ext = import_path9.default.extname(resource.path).slice(1).toLowerCase();
  ...
  diagnosticsReceived(diagnosticsKind, resource, diagnostics) {
    const config = import_coc30.workspace.getConfiguration(this.id, resource);
    const reportUnnecessary = config.get("showUnused", true);
    const reportDeprecated = config.get("showDeprecated", true);
    const reportConvertToAsyncFunction = config.get("showConvertToAsync", true);
    this.client.diagnosticsManager.updateDiagnostics(resource, this._diagnosticLanguage, diagnosticsKind, diagnostics.filter((diag) => {
      if (!reportUnnecessary) {
        if (diag.reportUnnecessary && diag.severity === import_coc30.DiagnosticSeverity.Information) {
          return false;
        }
      }
      if (!reportDeprecated) {
        if (diag.reportDeprecated && diag.severity === import_coc30.DiagnosticSeverity.Hint) {
          return false;
        }
      }
...
var getRootTempDir = /* @__PURE__ */ (() => {
  let dir;
  return () => {
    if (!dir) {
      dir = path10.join(os2.tmpdir(), `coc-tsserver`);
    }
...
var getInstanceTempDir = /* @__PURE__ */ (() => {
  let dir;
  return () => {
    dir ?? (dir = path10.join(getRootTempDir(), makeRandomHexString(20)));
    if (!fs4.existsSync(dir)) {
      fs4.mkdirSync(dir);
    }
    return dir;
...
function getTempFile(prefix) {
  return path10.join(getInstanceTempDir(), `${prefix}-${makeRandomHexString(20)}.tmp`);
}
...
// src/server/tsServer/logDirectoryProvider.ts
var base = path11.join(import_os2.default.tmpdir(), "coc-tsserver-log");
var NodeLogDirectoryProvider = class {
  ...
  getNewLogDirectory() {
    ...
    if (root) {
      try {
        return fs6.mkdtempSync(path11.join(root, `tsserver-log-`));
      } catch (e) {
        return void 0;
      }
    }
  ...
  logDirectory() {
    try {
      const path21 = base;
      if (!fs6.existsSync(path21)) {
        fs6.mkdirSync(path21, { recursive: true });
      }
      return path21;
    } catch {
      return void 0;
...
var Disposable7 = class {
  ...
  dispose() {
    ...
    (0, import_coc31.disposeAll)(this._disposables);
  }
  _register(value) {
    if (this._isDisposed) {
      value.dispose();
...
var TypeScriptServerError = class _TypeScriptServerError extends Error {
...
// src/server/tsServer/server.ts
init_typescriptService();
var _ProcessBasedTsServer = class _ProcessBasedTsServer extends Disposable7 {
  constructor(_serverId, _serverSource, _process, _tsServerLogFile, _requestCanceller, _version, _tracer) {
    ...
    this._onEvent = this._register(new import_coc32.Emitter());
    this.onEvent = this._onEvent.event;
    this._onExit = this._register(new import_coc32.Emitter());
...
_ProcessBasedTsServer.fenceCommands = /* @__PURE__ */ new Set(["change", "close", "open", "updateOpen"]);
var ProcessBasedTsServer = _ProcessBasedTsServer;
var _RequestRouter = class _RequestRouter {
  ...
  execute(command, args, executeInfo) {
    if (_RequestRouter.sharedCommands.has(command) && typeof executeInfo.executionTarget === "undefined") {
      ...
      let token = void 0;
      if (executeInfo.token) {
        const source = new import_coc32.CancellationTokenSource();
        executeInfo.token.onCancellationRequested(() => {
...
var _GetErrRoutingTsServer = class _GetErrRoutingTsServer extends Disposable7 {
  constructor(servers, delegate) {
    super();
    this._onEvent = this._register(new import_coc32.Emitter());
    this.onEvent = this._onEvent.event;
...
var _SyntaxRoutingTsServer = class _SyntaxRoutingTsServer extends Disposable7 {
...
var Reader = class extends Disposable7 {
  constructor(readable) {
    ...
    this.nextMessageLength = -1;
    this._onError = this._register(new import_coc33.Emitter());
    this.onError = this._onError.event;
    this._onData = this._register(new import_coc33.Emitter());
...
var SocketChildServerProcess = class extends Disposable7 {
  constructor(socket) {
    super();
    this.socket = socket;
    this._reader = this._register(new Reader(socket));
  }
  write(serverRequest) {
...
var ServiceProcessFactory = class {
  fork(version, args, kind, configuration) {
    ...
    if (configuration.socketPath) {
      let client = new import_net.Socket();
...
function defaultPathNormalizer(resource) {
  let u = import_coc34.Uri.parse(resource);
  if (u.scheme === "file") {
    return u.fsPath;
  }
...
var ResourceMap = class {
  ...
  isCaseInsensitivePath(path21) {
    if (isWindowsPath(path21)) {
      return true;
    }
    return path21[0] === "/" && this.onIsCaseInsenitiveFileSystem;
  }
...
function isWindowsPath(path21) {
  return /^[a-zA-Z]:\\/.test(path21);
}
...
function checkDocument(doc) {
  ...
  if (uri.endsWith(".jsx") && languageId !== "javascriptreact" || uri.endsWith(".tsx") && languageId !== "typescriptreact") {
    let u = import_coc35.Uri.parse(doc.uri);
    let basename = import_path10.default.basename(u.fsPath);
    if (doc.uri.endsWith(".jsx")) {
      import_coc35.window.showWarningMessage(`Possible wrong filetype "${doc.languageId}" with ${basename}, use javascriptreact as filetype to make tsserver work with react syntax.`);
    } else {
      import_coc35.window.showWarningMessage(`Possible wrong filetype "${doc.languageId}" with ${basename}, use typescriptreact as filetype to make tsserver work with react syntax.`);
    }
    warningShown = true;
  }
}
var SyncedBuffer = class {
  ...
  open() {
    let folder = import_coc35.workspace.getWorkspaceFolder(this.document.uri);
    checkDocument(this.document);
    const args = {
      file: this.filepath,
      fileContent: this.document.getText(),
      projectRootPath: folder ? import_coc35.Uri.parse(folder.uri).fsPath : void 0
    };
...
var SyncedBufferMap = class extends ResourceMap {
  getForPath(filePath) {
    return this.get(import_coc35.Uri.file(filePath).toString());
  }
  get allBuffers() {
    return this.values;
  }
...
var BufferSynchronizer = class {
  ...
  flush() {
    ...
    if (this._pending.size > 0) {
      ...
      this.client.execute("updateOpen", { changedFiles, closedFiles, openFiles }, import_vscode_languageserver_protocol15.CancellationToken.None, { nonRecoverable: true }).catch((e) => {
...
var GetErrRequest = class _GetErrRequest {
  constructor(client, uris, _token, onDone) {
    ...
    const allFiles = uris.filter((entry) => supportsSyntaxGetErr || client.hasCapabilityForResource(entry, 2 /* Semantic */)).map((entry) => client.toTsFilePath(entry));
    if (!allFiles.length) {
      this._done = true;
      setImmediate(onDone);
    } else {
  ...
  static executeGetErrRequest(client, uris, onDone) {
    const token = new import_vscode_languageserver_protocol15.CancellationTokenSource();
    return new _GetErrRequest(client, uris, token, onDone);
  }
  cancel() {
    if (!this._done) {
      this._token.cancel();
...
var BufferSyncSupport = class {
  constructor(client, modeIds) {
    ...
    this._onDelete = new import_vscode_languageserver_protocol15.Emitter();
    this.onDelete = this._onDelete.event;
    this._onWillChange = new import_vscode_languageserver_protocol15.Emitter();
    this.onWillChange = this._onWillChange.event;
    this.client = client;
    this.modeIds = new Set(modeIds);
    this.diagnosticDelayer = new Delayer(300);
    const pathNormalizer = (path21) => this.client.toPath(path21);
    ...
    import_coc35.workspace.onDidChangeConfiguration(this.updateConfiguration, this, this.disposables);
  }
  listen() {
    if (this.listening) return;
    this.listening = true;
    import_coc35.workspace.onDidOpenTextDocument(
      this.openTextDocument,
      this,
      this.disposables
    );
    import_coc35.workspace.onDidCloseTextDocument(
      this.onDidCloseTextDocument,
      this,
      this.disposables
    );
    import_coc35.workspace.onDidChangeTextDocument(
      this.onDidChangeTextDocument,
      this,
      this.disposables
    );
    import_coc35.workspace.textDocuments.forEach(this.openTextDocument, this);
  }
  handles(resource) {
  ...
  dispose() {
    ...
    (0, import_coc35.disposeAll)(this.disposables);
  ...
  ensureHasBuffer(resource) {
    ...
    const existingDocument = import_coc35.workspace.textDocuments.find((doc) => doc.uri.toString() === resource);
    if (existingDocument) {
      return this.openTextDocument(existingDocument);
    }
    return false;
  }
  toResourceUri(resource) {
  ...
  toResource(filePath) {
    ...
    return import_coc35.Uri.file(filePath).toString();
  }
  reset() {
    var _a;
  ...
  openTextDocument(document) {
    ...
    const filepath = this.client.toTsFilePath(import_coc35.Uri.parse(resource));
    if (!filepath) {
      return false;
    }
    if (this.syncedBuffers.has(resource)) {
  ...
  sendPendingDiagnostics() {
    ...
    if (orderedFileSet.size) {
      let uris = Array.from(orderedFileSet.uris).map((uri) => import_coc35.Uri.parse(uri));
  ...
  updateConfiguration() {
    const jsConfig = import_coc35.workspace.getConfiguration("javascript", null);
    const tsConfig = import_coc35.workspace.getConfiguration("typescript", null);
  ...
  getSuggestionDiagnostics(settings) {
    ...
    return this.get(2 /* Suggestion */).filter((x) => {
      if (!enableSuggestions) {
        return x.tags && (x.tags.includes(import_coc36.DiagnosticTag.Unnecessary) || x.tags.includes(import_coc36.DiagnosticTag.Deprecated));
      }
      return true;
    });
  }
...
var _DiagnosticSettings = class _DiagnosticSettings {
  constructor() {
...
var DiagnosticsManager = class extends Disposable7 {
  constructor() {
    ...
    this._currentDiagnostics = this._register(import_coc36.languages.createDiagnosticCollection("tsserver"));
  }
  dispose() {
    super.dispose();
...
var TsServerLogLevel = /* @__PURE__ */ ((TsServerLogLevel2) => {
  ...
  TsServerLogLevel2[TsServerLogLevel2["RequestTime"] = 4] = "RequestTime";
...
var ImplicitProjectConfiguration = class _ImplicitProjectConfiguration {
  constructor(configuration) {
    ...
    this.strict = _ImplicitProjectConfiguration.readImplicitStrict(configuration);
  }
  isEqualTo(other) {
  ...
  static readImplicitStrict(configuration) {
    return configuration.get("tsserver.implicitProjectConfig.strict", true);
  }
};
var ServiceConfigurationProvider = class {
  loadFromWorkspace() {
    const configuration = import_coc37.workspace.getConfiguration();
    return {
      enable: this.readEnable(configuration),
      locale: this.readLocale(configuration),
      socketPath: configuration.get("tsserver.socketPath", void 0),
  ...
  fixPathPrefixes(inspectValue) {
    const pathPrefixes = ["~" + import_path11.default.sep];
    for (const pathPrefix of pathPrefixes) {
      if (inspectValue.startsWith(pathPrefix)) {
        return import_path11.default.join(import_os3.default.homedir(), inspectValue.slice(pathPrefix.length));
      }
    }
    return inspectValue;
  }
  ...
  readDisabledSchemes(configuration) {
    return configuration.get("tsserver.disabledSchemes", []);
  }
...
// src/server/tsServer/spawner.ts
var TypeScriptServerSpawner = class _TypeScriptServerSpawner {
  ...
  getTsServerArgs(kind, configuration, currentVersion, apiVersion, pluginManager, cancellationPipeName) {
    ...
    if (_TypeScriptServerSpawner.isLoggingEnabled(configuration)) {
      ...
      if (logDir) {
        tsServerLogFile = path15.join(logDir, `tsserver.log`);
    ...
    let locale = _TypeScriptServerSpawner.getTsLocale(configuration);
...
var TypeScriptVersion = class {
  constructor(path21, _pathLabel) {
    this.path = path21;
    this._pathLabel = _pathLabel;
    this._api = null;
  }
  get tscPath() {
    return import_path12.default.resolve(this.path, `../bin/tsc${process.platform == "win32" ? ".exe" : ""}`);
  }
  get tsServerPath() {
    return import_path12.default.resolve(this.path, "tsserver.js");
  }
  get pathLabel() {
  ...
  getTypeScriptVersion(serverPath) {
    ...
    const p = serverPath.split(import_path12.default.sep);
    if (p.length <= 2) {
      return void 0;
    }
    const p2 = p.slice(0, -2);
    const modulePath = p2.join(import_path12.default.sep);
    let fileName = import_path12.default.join(modulePath, "package.json");
    if (!import_fs6.default.existsSync(fileName)) {
      if (import_path12.default.basename(modulePath) === "built") {
        fileName = import_path12.default.join(modulePath, "..", "package.json");
      }
    }
    if (!import_fs6.default.existsSync(fileName)) {
      return void 0;
...
var TypeScriptVersionProvider = class {
  ...
  get globalVersion() {
    let { globalTsdk } = this.configuration;
    let folder = import_coc38.workspace.expand(globalTsdk);
    if (!import_path12.default.isAbsolute(folder)) {
      folder = import_path12.default.join(import_coc38.workspace.root, folder);
    }
    if (globalTsdk) return new TypeScriptVersion(folder);
    return void 0;
  }
  getVersionFromTscPath(tscPath) {
    if (!tscPath || !import_fs6.default.existsSync(tscPath)) return void 0;
    let libFolder = import_path12.default.resolve(tscPath, "../../lib");
  ...
  getLocalVersionFromFolder(workspaceRoot) {
    for (let folder of MODULE_FOLDERS) {
      let libFolder = import_path12.default.join(workspaceRoot, folder);
      if (import_fs6.default.existsSync(libFolder)) {
        let version = new TypeScriptVersion(libFolder);
        if (version.isValid) return version;
      }
  ...
  getLocalVersion() {
    ...
    if (localTsdk) {
      let folder = import_coc38.workspace.expand(localTsdk);
      if (!import_path12.default.isAbsolute(folder)) {
        folder = import_path12.default.join(import_coc38.workspace.root, folder);
      }
      ...
      void import_coc38.window.showWarningMessage(`Invalid tsserver version from folder configuration "tsserver.tsdk"`);
    }
    let version = this.getLocalVersionFromFolder(import_coc38.workspace.root);
  ...
  get bundledVersion() {
    try {
      ...
      const bundledVersion = new TypeScriptVersion(
        import_path12.default.dirname(file2),
        ""
      );
      return bundledVersion;
    } catch (e) {
      import_coc38.window.showErrorMessage("Bundled typescript module not found");
      return null;
    }
  }
};
...
var Logger2 = class {
  get output() {
    ...
    this._channel = import_coc39.window.createOutputChannel("tsserver");
    return this._channel;
  }
  dispose() {
    if (this._channel) {
...
// src/server/utils/generation.ts
...
var RelativeWorkspacePathResolver = class {
  static asAbsoluteWorkspacePath(relativePath) {
    for (const root of import_coc40.workspace.workspaceFolders || []) {
      const rootPrefixes = [`./${root.name}/`, `${root.name}/`, `.\\${root.name}\\`, `${root.name}\\`];
      for (const rootPrefix of rootPrefixes) {
        if (relativePath.startsWith(rootPrefix)) {
          return path17.join(import_coc40.Uri.parse(root.uri).fsPath, relativePath.replace(rootPrefix, ""));
        }
      }
    }
    return void 0;
...
var TypeScriptPluginPathsProvider = class {
  ...
  resolvePluginPath(pluginPath) {
    if (path18.isAbsolute(pluginPath)) {
      return [pluginPath];
    }
    ...
    return (import_coc41.workspace.workspaceFolders || []).map((workspaceFolder) => path18.join(import_coc41.Uri.parse(workspaceFolder.uri).fsPath, pluginPath));
  }
};
...
var Tracer = class _Tracer {
  ...
  updateConfiguration() {
    this.trace = _Tracer.readTrace();
  }
  static readTrace() {
    let result = Trace.fromString(import_coc42.workspace.getConfiguration("tsserver").get("trace.server", "off"));
...
function inferredProjectCompilerOptions(version, projectType, serviceConfig) {
  ...
  if (serviceConfig.implicitProjectConfiguration.checkJs && projectType === 0 /* TypeScript */) {
...
var VersionStatus = class {
  constructor() {
    this._versionString = "";
    this._versionBarEntry = import_coc44.window.createStatusBarItem(99);
    this._onChangeEditor = import_coc44.window.onDidChangeActiveTextEditor(this.onChangeEditor, this);
...
// src/server/typescriptServiceClient.ts
var inMemoryResourcePrefix = "^";
var emptyAuthority = "ts-nul-authority";
var ServerState;
((ServerState2) => {
  let Type;
  ((Type2) => {
...
var noPrefixSchemes = /* @__PURE__ */ new Set();
var TypeScriptServiceClient = class extends Disposable7 {
  constructor(context, modeIds, services2, tscPathVim) {
    ...
    this.token = 0;
    this.state = import_coc45.ServiceStat.Initial;
    ...
    this._onTsServerStarted = this._register(new import_coc45.Emitter());
    this.onTsServerStarted = this._onTsServerStarted.event;
    this._onDiagnosticsReceived = this._register(new import_coc45.Emitter());
    this.onDiagnosticsReceived = this._onDiagnosticsReceived.event;
    this._onConfigDiagnosticsReceived = this._register(new import_coc45.Emitter());
    this.onConfigDiagnosticsReceived = this._onConfigDiagnosticsReceived.event;
    this._onResendModelsRequested = this._register(new import_coc45.Emitter());
    this.onResendModelsRequested = this._onResendModelsRequested.event;
    this._onProjectLanguageServiceStateChanged = this._register(new import_coc45.Emitter());
    this.onProjectLanguageServiceStateChanged = this._onProjectLanguageServiceStateChanged.event;
    this._onDidBeginInstallTypings = this._register(new import_coc45.Emitter());
    this.onDidBeginInstallTypings = this._onDidBeginInstallTypings.event;
    this._onDidEndInstallTypings = this._register(new import_coc45.Emitter());
    this.onDidEndInstallTypings = this._onDidEndInstallTypings.event;
    this._onTypesInstallerInitializationFailed = this._register(new import_coc45.Emitter());
    this.onTypesInstallerInitializationFailed = this._onTypesInstallerInitializationFailed.event;
    this._onDidChangeCapabilities = this._register(new import_coc45.Emitter());
    ...
    this.pathSeparator = import_path13.default.sep;
    ...
    import_coc45.workspace.onDidChangeConfiguration(() => {
  ...
  restartTsServer(fromUserAction = false) {
    ...
    if (this.serverState.type === 1 /* Running */) {
      ...
      this.state = import_coc45.ServiceStat.Stopping;
      this.serverState.server.kill();
    }
    if (fromUserAction) {
      this.hasServerFatallyCrashedTooManyTimes = false;
  ...
  startService(resendModels = false) {
    ...
    if (!version.isValid) {
      void import_coc45.window.showWarningMessage(`The path ${version.path} doesn't point to a valid tsserver install. Falling back to bundled TypeScript version.`);
    ...
    this.state = import_coc45.ServiceStat.Starting;
    ...
    handle.onError((err) => {
      ...
      if (err) {
        this.state = import_coc45.ServiceStat.StartFailed;
        import_coc45.window.showErrorMessage(`TypeScript language server exited with error. Error message is: ${err.message || err.name}`);
      }
    ...
    handle.onExit((data) => {
      ...
      this.state = import_coc45.ServiceStat.Stopped;
      if (handle.tsServerLogFile) {
  ...
  async openTsServerLogFile() {
    ...
    let showWarning = (msg) => {
      import_coc45.window.showWarningMessage(msg);
    };
    if (isRoot) {
    ...
    try {
      let uri = import_coc45.Uri.file(tsServerLogFile);
      await import_coc45.workspace.jumpTo(uri.toString(), void 0, "tabe");
      return true;
    } catch {
  ...
  serviceStarted(resendModels) {
    ...
    for (const plugin of this.pluginManager.plugins) {
      ...
      try {
        ...
        const nmIdx = pkgPath.lastIndexOf(import_path13.default.sep + "node_modules" + import_path13.default.sep);
        if (nmIdx !== -1) {
    ...
    if (restart) {
      ...
      if (this.numberRestarts > 5) {
        ...
        if (diff < 10 * 1e3) {
          ...
          import_coc45.window.showErrorMessage(
...
This may be caused by a plugin contributed by one of these extensions: ${pluginExtensionList}` : "The JS/TS language service immediately crashed 5 times. The service will not be restarted."
          ...
          this.lastStart = Date.now();
          import_coc45.window.showWarningMessage(
...
This may be caused by a plugin contributed by one of these extensions: ${pluginExtensionList}` : "The JS/TS language service crashed 5 times in the last 5 Minutes."
  ...
  toPath(uri) {
    return this.toTsFilePath(import_coc45.Uri.parse(uri));
  }
  ...
  toResource(filepath) {
    ...
    if (filepath.startsWith(inMemoryResourcePrefix)) {
      ...
      if (parts) {
        ...
        let resource = import_coc45.Uri.parse(parts[1] + "://" + (parts[2] === emptyAuthority ? "" : parts[2]) + "/" + parts[3]);
  ...
  toTsFilePath(resource) {
    ...
    switch (resource.scheme) {
      case file: {
        ...
        result = import_path13.default.normalize(result);
  ...
  getDocument(resource) {
    return import_coc45.workspace.getDocument(resource);
  }
  execute(command, args, token, config) {
    ...
    if (config == null ? void 0 : config.cancelOnResourceChange) {
      ...
      if (runningServerState.type === 1 /* Running */) {
        const source = new import_coc45.CancellationTokenSource();
  ...
  fatalError(command, error) {
    ...
    this.error(msg);
    import_coc45.window.showErrorMessage(msg);
  ...
  dispatchEvent(event) {
    ...
    switch (event.event) {
      ...
      case "projectsUpdatedInBackground" /* projectsUpdatedInBackground */: {
        this.versionStatus.loading = false;
        const body = event.body;
        const resources = body.openFiles.map((file2) => import_coc45.Uri.parse(this.toResource(file2)));
  ...
  getWorkspaceRootForResource(resource) {
    const roots = import_coc45.workspace.workspaceFolders ? Array.from(import_coc45.workspace.workspaceFolders) : void 0;
    if (!(roots == null ? void 0 : roots.length)) return void 0;
    const uris = roots.map((f) => import_coc45.Uri.parse(f.uri));
    switch (resource.scheme) {
      case file:
      case untitled:
      ...
      case memFs:
        for (const uri of uris.sort((a, b) => a.fsPath.length - b.fsPath.length)) {
          if (resource.fsPath.startsWith(uri.fsPath + import_path13.default.sep)) {
            return uri.fsPath;
          }
        }
...
var AtaProgressReporter = class {
  constructor(client) {
    ...
    this._invalid = false;
    this.statusItem = import_coc46.window.createStatusBarItem(10, { progress: true });
    const disposables = [];
    ...
    this._disposable = import_vscode_languageserver_protocol16.Disposable.create(() => {
  ...
  async onTypesInstallerInitializationFailed() {
    this.statusItem.hide();
    if (!this._invalid) {
      const config = import_coc46.workspace.getConfiguration("typescript");
      if (config.get("check.npmIsInstalled", true)) {
        const dontShowAgain = "Don't Show Again";
        const selected = await import_coc46.window.showWarningMessage(
...
// src/server/utils/reloadProjects.ts
function requestReloadProjects(client) {
...
var TypeScriptServiceClientHost = class {
  constructor(descriptions, pluginManager, tscPath, context) {
    ...
    const configFileWatcher = import_coc48.workspace.createFileSystemWatcher("**/[tj]sconfig.json");
    ...
    const packageFileWatcher = import_coc48.workspace.createFileSystemWatcher("**/package.json");
    ...
    this.disposables.push(import_coc48.languages.registerWorkspaceSymbolProvider(new TypeScriptWorkspaceSymbolProvider(this.client, allModeIds)));
    ...
    this.client.onConfigDiagnosticsReceived((diag) => {
      ...
      if (body) {
        ...
        let uri = import_coc48.Uri.file(configFile).toString();
        if (diagnostics.length == 0) {
          ...
          let diagnosticList = diagnostics.map((diag2) => {
            ...
            let range;
            if (!start || !end) {
              range = import_coc48.Range.create(0, 0, 0, 1);
            } else {
              range = import_coc48.Range.create(start.line - 1, start.offset - 1, end.line - 1, end.offset - 1);
            }
            let severity = this.getDiagnosticSeverity(diag2);
            return import_coc48.Diagnostic.create(range, text, severity, code);
          });
    ...
    import_coc48.workspace.onDidChangeConfiguration(this.configurationChanged, this, this.disposables);
    this.configurationChanged();
  }
  ...
  async findLanguage(uri) {
    try {
      ...
      if (doc) return languages4.find((language2) => language2.handles(uri, doc.textDocument));
      return languages4.find((language2) => language2.handlesUri(import_coc48.Uri.parse(uri)));
    } catch {
      return void 0;
    }
  }
  ...
  tsDiagnosticToLspDiagnostic(diagnostic) {
    ...
    if (diagnostic.reportsUnnecessary) {
      tags.push(import_coc48.DiagnosticTag.Unnecessary);
    }
    if (diagnostic.reportsDeprecated) {
      tags.push(import_coc48.DiagnosticTag.Deprecated);
    }
  ...
  getDiagnosticSeverity(diagnostic) {
    if (this.reportStyleCheckAsWarnings && this.isStyleCheckDiagnostic(diagnostic.code) && diagnostic.category === DiagnosticCategory.error) {
      return import_coc48.DiagnosticSeverity.Warning;
    }
    switch (diagnostic.category) {
      case DiagnosticCategory.error:
        return import_coc48.DiagnosticSeverity.Error;
      case DiagnosticCategory.warning:
        return import_coc48.DiagnosticSeverity.Warning;
      case DiagnosticCategory.suggestion:
        return import_coc48.DiagnosticSeverity.Hint;
      default:
        return import_coc48.DiagnosticSeverity.Error;
    }
  }
...
var TsserverService = class {
  constructor(pluginManager, context) {
    ...
    this.id = "tsserver";
    this.name = "tsserver";
    this._state = import_coc49.ServiceStat.Initial;
    this._onDidServiceReady = new import_coc49.Emitter();
    this.onServiceReady = this._onDidServiceReady.event;
    this.disposables = [];
    this.descriptions = [];
    const config = import_coc49.workspace.getConfiguration("tsserver");
    this.enable = config.get("enable");
    this.descriptions = standardLanguageDescriptions.filter((o) => {
      return true;
    });
    import_coc49.workspace.onDidChangeConfiguration((e) => {
      if (e.affectsConfiguration("tsserver")) {
        const config2 = import_coc49.workspace.getConfiguration("tsserver");
  ...
  registCommands() {
    ...
    const registCommand2 = (cmd) => {
      let { id, execute } = cmd;
      subscriptions.push(import_coc49.commands.registerCommand(id, execute, cmd));
    };
    ...
    registCommand2({
      ...
      execute: async (command, args, options) => {
        ...
        const client = host.serviceClient;
        ...
        const results = serverState.server.executeImpl(command, args, {
          isAsync: (options == null ? void 0 : options.isAsync) ?? false,
          token: void 0,
          expectsResult: true,
          lowPriority: (options == null ? void 0 : options.lowPriority) ?? false
        });
        if (!results || !results[0]) return void 0;
  ...
  get config() {
    return import_coc49.workspace.getConfiguration("tsserver");
  }
  /**
   * Get running client host.
   */
  getClientHost() {
    if (this.state == import_coc49.ServiceStat.Running) return Promise.resolve(this.clientHost);
    this.start();
    return new Promise((resolve, reject) => {
  ...
  async start() {
    if (!this.enable || this._state == import_coc49.ServiceStat.Starting) return;
    this._state = import_coc49.ServiceStat.Starting;
    if (this.clientHost) {
      let client2 = this.clientHost.serviceClient;
      client2.restartTsServer(true);
      return;
    }
    let tscPath = await import_coc49.workspace.nvim.getVar("Coc_tsserver_path");
  ...
  async stop() {
    ...
    let client = this.clientHost.serviceClient;
    client.stop();
    await (0, import_coc49.wait)(30);
    (_a = this.clientHost) == null ? void 0 : _a.dispose();
    this.clientHost = null;
    this._state = import_coc49.ServiceStat.Stopped;
  }
  dispose() {
    void this.stop();
    this._onDidServiceReady.dispose();
    (0, import_coc49.disposeAll)(this.disposables);
  }
};
...
var PluginManager = class {
  constructor() {
    ...
    this._disposables = [];
    this._onDidUpdatePlugins = this._register(new import_coc50.Emitter());
    this.onDidChangePlugins = this._onDidUpdatePlugins.event;
    this._onDidUpdateConfig = this._register(new import_coc50.Emitter());
    ...
    import_coc50.extensions.onDidActiveExtension(loadPlugins, void 0, this._disposables);
    import_coc50.extensions.onDidUnloadExtension(loadPlugins, void 0, this._disposables);
  }
  dispose() {
    (0, import_coc50.disposeAll)(this._disposables);
  }
  get plugins() {
    if (!this._plugins) {
  ...
  readPlugins() {
    ...
    for (const extension of import_coc50.extensions.all) {
...
async function activate(context) {
  ...
  subscriptions.push(import_coc51.services.register(service));
  return {
